...
for(ronda=1;ronda<=2;ronda++){
    ...
    while(cb!=1){
        ...
        if(puntosAcum!=0||ronda>1) {
                ...
                TextColor(10);
                Say(40,5,"PUNTOS DE LA TIRADA ANTERIOR:");cout<<puntosAcum;

         SetColorC(14,7);
        Rectangulo(82,4,25,2,REC1);
        TextColor(6);
      Say(82,5,"PUNTOS DE ESTA RONDA:" ); cout<<puntosCorte;}
...
//===============================================================================================================================================
    ...
    puntosTotales2=puntosTotales2-cantFallidas2;
